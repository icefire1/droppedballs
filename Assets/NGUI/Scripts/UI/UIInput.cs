...
public class UIInput : MonoBehaviour
{
	...
	protected void Submit ()
	{
		if (NGUITools.IsActive(this))
		{
			...
			SaveToPlayerPrefs(mValue);
			// Couldn't figure out how to use this crap -.-'
			// So I made it send a message instead :/
			Debug.Log ("submitted");
			gameObject.SendMessage("OnSubmit", value, SendMessageOptions.DontRequireReceiver);
		}
	}
